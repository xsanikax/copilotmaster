...
import com.beagleflipper.model.SuggestionManager;
...
public class KeybindHandler {
    ...
    @Inject
    public KeybindHandler(KeyManager keyManager, BeagleFlipperConfig config, ClientThread clientThread, SuggestionManager suggestionManager, Client client, GrandExchange grandExchange, OfferHandler offerHandler) {
