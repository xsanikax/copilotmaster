...
import com.beagleflipper.model.PremiumInstanceStatus;
...
public class PremiumInstancePanel extends JPanel {
    ...
    public PremiumInstancePanel(BeagleFlipperConfig config, ApiRequestHandler apiRequestHandler, SuggestionManager suggestionManager) {
        this.config = config;
