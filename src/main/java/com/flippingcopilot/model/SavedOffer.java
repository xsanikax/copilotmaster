...
public class SavedOffer {
	private String id; // The client expects an ID for transactions
	private int itemId;
	...
	public static SavedOffer fromGrandExchangeOffer(GrandExchangeOffer offer) {
		...
		o.setAcked(false);
		o.setCopilotPriceUsed(false);
		o.setWasCopilotSuggestion(false);
		return o;
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(itemId, quantitySold, totalQuantity, price, spent, state);
	}
}